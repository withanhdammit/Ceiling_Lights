...
byte allowedcolors[5][3] ={
  { 17, 177, 13 },    //11B10D Yellow Green Color Wheel
  { 148, 242, 5 },    //94F205 Green Lizard
  { 25, 173, 121},    //19AD79 Green Crayola
  { 250, 77, 127 },   //FA4D7F French Rose
  { 171, 101, 221 },  //AB65DD Amethyst
  // alternate colors
  //{ 20, 232, 30 }, //14E81E Erin (greenish)
  //{ 0, 234, 141 }, //00EA8D Medium Spring Green
  //{ 1, 126, 213 }, //017ED5 Green Blue Crayola
  //{ 181, 61, 255 },//B53DFF Electric Purple
  //{ 141, 0, 196 }, //8D00C4 French Violet
};
...
byte colorweighting[3][5] = {
  ...
  {3, 3, 3, 3, 2}         //Weighting greenish (green colors are more likely)
};
...
//        showStrip();
    ...
    case INITIALIZE:
      ...
      break;
    case GET_NAME:
      return "Aurora Borealis";  // return your effect's name here
  }
}
